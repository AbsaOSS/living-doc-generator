...
from living_documentation_regime.utils.decorators import debug_log_decorator, safe_call_decorator
...
def test_debug_log_decorator(mocker):
    # Mock logging
    mock_log_debug = mocker.patch("living_documentation_regime.utils.decorators.logger.debug")
...
def test_safe_call_decorator_network_error(rate_limiter, mocker):
    mock_log_error = mocker.patch("living_documentation_regime.utils.decorators.logger.error")
